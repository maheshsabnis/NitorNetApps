...
namespace MVC_IdentityApp.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpNo,EmpName,Designation,Salary,DeptNo")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpNo,EmpName,Designation,Salary,DeptNo")] Employee employee)
        {
            if (ModelState.IsValid)
            {
